...
并将此处(opens in a new tab)的所有内容复制进去。
...
2. YAML 语法
配置文件 _config.redefine.yml 使用 YAML 语法，如果你不熟悉 YAML 语法，请先阅读此处(opens in a new tab)。
